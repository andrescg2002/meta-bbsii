SUMMARY = "Scripts to support an eMMC installation"
...
do_install_append () {
    ...
    install -m 0755 emmc_mk4parts.sh ${D}${bindir}
    ...
    install -m 0755 emmc_copy_data.sh ${D}${bindir}
